...
func (i *PeeringConnection) ToOutput(ctx context.Context) pulumix.Output[*PeeringConnection] {
	return pulumix.Output[*PeeringConnection]{
		OutputState: i.ToPeeringConnectionOutputWithContext(ctx).OutputState,
	}
}
...
func (i PeeringConnectionArray) ToOutput(ctx context.Context) pulumix.Output[[]*PeeringConnection] {
	return pulumix.Output[[]*PeeringConnection]{
		OutputState: i.ToPeeringConnectionArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i PeeringConnectionMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*PeeringConnection] {
	return pulumix.Output[map[string]*PeeringConnection]{
		OutputState: i.ToPeeringConnectionMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o PeeringConnectionOutput) ToOutput(ctx context.Context) pulumix.Output[*PeeringConnection] {
	return pulumix.Output[*PeeringConnection]{
...
func (o PeeringConnectionArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*PeeringConnection] {
	return pulumix.Output[[]*PeeringConnection]{
		OutputState: o.OutputState,
	}
}
...
func (o PeeringConnectionMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*PeeringConnection] {
	return pulumix.Output[map[string]*PeeringConnection]{
		OutputState: o.OutputState,
	}
}
