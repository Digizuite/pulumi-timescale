...
func (i *Vpcs) ToOutput(ctx context.Context) pulumix.Output[*Vpcs] {
	return pulumix.Output[*Vpcs]{
		OutputState: i.ToVpcsOutputWithContext(ctx).OutputState,
	}
}
...
func (i VpcsArray) ToOutput(ctx context.Context) pulumix.Output[[]*Vpcs] {
	return pulumix.Output[[]*Vpcs]{
		OutputState: i.ToVpcsArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i VpcsMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*Vpcs] {
	return pulumix.Output[map[string]*Vpcs]{
		OutputState: i.ToVpcsMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o VpcsOutput) ToOutput(ctx context.Context) pulumix.Output[*Vpcs] {
	return pulumix.Output[*Vpcs]{
...
func (o VpcsArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*Vpcs] {
	return pulumix.Output[[]*Vpcs]{
		OutputState: o.OutputState,
	}
}
...
func (o VpcsMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*Vpcs] {
	return pulumix.Output[map[string]*Vpcs]{
		OutputState: o.OutputState,
	}
}
