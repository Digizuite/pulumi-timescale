...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `timescale` with the `NAME` of your provider.
...
before:
  ...
  - make tfgen
builds:
- binary: pulumi-resource-timescale
  dir: provider
  goarch:
  - amd64
  - arm64
...
├── config.yaml
├── metadata.json
├── pulumi-timescale_darwin_amd64_v1
│   └── pulumi-resource-timescale
├── pulumi-timescale_darwin_arm64
│   └── pulumi-resource-timescale
├── pulumi-timescale_linux_amd64_v1
│   └── pulumi-resource-timescale
├── pulumi-timescale_linux_arm64
│   └── pulumi-resource-timescale
├── pulumi-timescale_windows_amd64_v1
│   └── pulumi-resource-timescale.exe
└── pulumi-timescale_windows_arm64
    └── pulumi-resource-timescale.exe
```
